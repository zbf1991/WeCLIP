...
def cams_to_affinity_label(cam_label, mask=None, ignore_index=255, clip_flag=16):
    
    b,h,w = cam_label.shape
    
    cam_label_resized = F.interpolate(cam_label.unsqueeze(1).type(torch.float32), size=[h//clip_flag, w//clip_flag], mode="nearest")
