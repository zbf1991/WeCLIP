...
parser.add_argument("--model_path", default="/data1/zbf_data/FinalCodeGithub/WeCLIP_final_version/WeCLIP+/"
                                            "scripts/work_dir_voc/checkpoints/2025-03-11-10-47/wetr_iter_30000.pth", type=str, help="model_path")
