...
parser.add_argument("--model_path", default="/data1/zbf_data/Project2023_zbf/Myafa_CLIP/scripts/work_dir_voc/checkpoints"
                                            "/2023-10-12-10-10/wetr_iter_30000.pth", type=str, help="model_path")
